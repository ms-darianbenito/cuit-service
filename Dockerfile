...
FROM mcr.microsoft.com/dotnet/core/sdk:3.1.301-buster AS restore
WORKDIR /src
COPY ./*.sln ./
COPY */*.csproj ./
...
FROM mcr.microsoft.com/dotnet/core/aspnet:3.1.5-buster-slim AS final
